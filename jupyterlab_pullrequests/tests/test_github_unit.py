...
class TestGetCurrentUser(TestCase):
    ...
    @patch(
        "jupyterlab_pullrequests.github_manager.PullRequestsGithubManager.call_github",
...
class TestGetFileContent(TestCase):
    ...
    @patch(
        "jupyterlab_pullrequests.github_manager.PullRequestsGithubManager.get_link_content",
        new_callable=CoroutineMock,
    )
    @patch(
        "jupyterlab_pullrequests.github_manager.PullRequestsGithubManager.validate_pr_link",
        new_callable=CoroutineMock,
    )
    @patch(
        "jupyterlab_pullrequests.github_manager.PullRequestsGithubManager.get_pr_links",
        new_callable=CoroutineMock,
    )
    @pytest.mark.asyncio
